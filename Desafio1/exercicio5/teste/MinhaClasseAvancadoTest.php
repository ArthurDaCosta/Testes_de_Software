...
class MinhaClasseAvancadoTest extends TestCase
{
    public function testSomar()
    {
        ...
        $this->assertEquals(1   , $minhaClasse->somar(0.5, 0.5));   //Soma de números decimais positivos
    }
    ...
    public function testSomarArgumentosInválidos()
    {
        ...
        $this->assertEquals('Um dos valores informados não é um número' , $minhaClasse->somar(2, null)); //Soma de número com bool
    }
    ...
    public function testSubtrair()
    {
        ...
        $this->assertEquals(1   , $minhaClasse->subtrair(0.5, -0.5));   //Subtração de números decimais positivos e negativos
    }
    ...
    public function testSubtrairArgumentosInválidos()
    {
        ...
        $this->assertEquals('Um dos valores informados não é um número' , $minhaClasse->subtrair(2, null)); //Subtração de número com bool
    }
}